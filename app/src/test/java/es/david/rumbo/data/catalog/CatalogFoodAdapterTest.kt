...
class CatalogFoodAdapterTest {
    ...
    fun realCarrefourOilKeepsProductAndListingIdentityAndMapsToLegacyFood() {
        ...
        assertEquals(CulinaryType.CULINARY_OIL, food.culinaryType)
    ...
    private fun product(
        ...
        culinaryRoles: Set<String> = emptySet(),
