...
### Peso seco frente a cocido

Rumbo almacena los gramos del producto que figura en el catálogo. En arroz y pasta secos, por tanto, el rol `PLATE_BASE` trabaja inicialmente con peso seco. No se pueden trasladar de forma literal gramajes de guías que expresan arroz/pasta cocidos. Como contraste práctico, documentación sanitaria británica sitúa una porción típica de arroz seco en torno a 75 g; por eso la zona satisfactoria v1 de `PLATE_BASE` se centra alrededor de ese orden de magnitud y no de 75–220 g cocidos.

Fuente: https://www.whittington.nhs.uk/default.asp?c=35962&print=1
...
| PLATE_BASE | 50–120 | 0.50 | 0.70–1.50 |
