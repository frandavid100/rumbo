...
def build_precision_primary_column_variants(
    ...
    The crop ratios deliberately match the already-audited primary-column rescue.
    Only the rasterization changes: 3x Lanczos, light contrast enhancement,
    unsharp masking, and lossless PNG. No crop is combined with another crop.
    """
