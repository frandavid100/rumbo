...
from audit_mercadona_p9_two_family_two_uncorroborated_core_candidates import candidate_payload

CORE = {"calories": 100.0, "protein_g": 5.0, "carbohydrate_g": 12.0, "fat_g": 3.0}


def row(*, families=2, corroborated=2, perspective=9, basis="100_g", nutrition=None, reasons=None,
...
class CandidatePayloadTests(unittest.TestCase):
    def test_two_family_two_uncorroborated_core_is_candidate(self):
