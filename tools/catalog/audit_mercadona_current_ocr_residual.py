...
def audit(
    ...
    summary = {
        ...
        "policy": (
            ...
            "Routing profiles use only first-party fields and perspective=9 availability. No OCR is run, no image is downloaded, "
            "no semantic classification is assigned, and no nutrition is promoted."
        ),
